...
function upsert({ citation, url, source_type, trust_level, notes }, { db = open(), actor = 'unknown', reason } = {}) {
...
function attach(nodeRef, sourceId, { evidence, db = open(), actor = 'unknown', reason } = {}) {
